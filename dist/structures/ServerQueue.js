/* eslint-disable no-nested-ternary */ import { SongManager } from "../utils/structures/SongManager";
...
export class ServerQueue {
    ...
    set lastMusicMsg(value) {
        if (this._lastMusicMsg !== null) {
            this.textChannel.messages.fetch(this._lastMusicMsg, {
                cache: false
            }).then((msg)=>{
                void msg.delete();
    ...
    set lastVSUpdateMsg(value) {
        if (this._lastVSUpdateMsg !== null) {
            this.textChannel.messages.fetch(this._lastVSUpdateMsg, {
                cache: false
            }).then((msg)=>{
                void msg.delete();
